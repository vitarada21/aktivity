...
export function WavesIcon({ className, size = 48 }: IconProps) {
  return (
...
export function DumbbellIcon({ className, size = 48 }: IconProps) {
  return (
    <svg {...baseProps(size, className)}>
...
export function BikeIcon({ className, size = 48 }: IconProps) {
  return (
    <svg {...baseProps(size, className)}>
